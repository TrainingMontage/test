...
POSTCONDITIONS:
\begin{enumerate}
	\item The switch attached to block 1 should be makred active in the database.
\end{enumerate}
...
TEST CASE: Get the authority corresponding to a train's location on the track
...
TEST CASE: Get the suggested speed corresponding to a train's location on the track
PRECONDITIONS: The TrackModel has been created as _tm, and test track data has been inserted into the database. A train has been initialized on block 1.
EXECUTION STEPS:
\begin{enumerate}
...
TEST CASE: Get the grade corresponding to a train's location
PRECONDITIONS: The TrackModel has been created as _tm, and test track data has been inserted into the database. A train has been initialized on block 1.
EXECUTION STEPS:
\begin{enumerate}
	\item _tm.getGrade(1)
