...
\resizebox{!}{.8\textheight}{
	\begin{mpost}
		...
		Actor.trackuser("TrackModel User");
	    % 
		...
		%
		Usecase.uT("Import Track");
		Usecase.uU("Export Track");
		Usecase.uV("Configure Track");
	    %
	    Component.TrackModel("Track Model")(uA,uB,uC,uD,uDD,uE,uF,uG,uH,uI,uJ,uK,uKK,uL,uM,uN,uO,uP,uQ,uR,uS,uT,uU,uV);
	    % 
		...
		%
		topToBottom.right(10)(uT,uU,uV);
		topToBottom.right(10)(uL,uM,uN,uP,uQ,uR,uS,uKK);
		leftToRight(75)(uO, uT);
		leftToRight(100)(uDD, uL);
		leftToRight(50)(uU, trackuser);
		leftToRight(50)(uL, trainmodel);
		leftToRight(50)(uKK, simrunner);
	    % 
	    drawObjects(ctc,wayside,trainmodel,traincontroller,simrunner,TrackModel,trackuser);
		%
...
\resizebox{\textwidth}{!}{
	...
	\begin{call}{sim}{getStaticSwitch(id)}{tm}{}
		...
		\begin{sdblock}{For Root, Default, Active}{}
			\begin{call}{tm}{getStaticBlock(id)}{tm}{}
				\begin{call}{tm}{execute(stmt)}{db}{}
				\end{call}
			\end{call}
		\end{sdblock}
...
\subsection{Sequence Diagram: Import Track}
\begin{center}
\resizebox{\textwidth}{!}{
	\begin{sequencediagram}
	\newthread{sim}{Actor}
	...
	\begin{call}{sim}{importTrack(File)}{tm}{}
		\begin{sdblock}{For Each Line}{Insert Row}
			\begin{call}{tm}{execute(stmt)}{db}{}
			\end{call}
		\end{sdblock}
	\end{call}
...
\subsection{Sequence Diagram: Export Track}
\begin{center}
\resizebox{\textwidth}{!}{
	\begin{sequencediagram}
	\newthread{sim}{Actor}
	...
	\begin{call}{sim}{exportTrack(File)}{tm}{}
		\begin{call}{tm}{execute(stmt)}{db}{}
		\end{call}
		\begin{sdblock}{For Each Row Returned}{}
			\begin{call}{tm}{Write to File}{tm}{}
			\end{call}
		\end{sdblock}
	\end{call}
	\end{sequencediagram}
