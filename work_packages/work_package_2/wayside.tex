...
\providecommand{\use}[1]{\subsection{Use Case: #1}}
    ...
    \subsection{Sequence Diargam: Toggle Switch State (Variation: Unsafe Toggle)}
    \begin{center}
    \resizebox{\textwidth}{!}{
        \begin{sequencediagram}
            \newthread{ctc}{CTC}
    ...
    \subsection{Sequence Diargam: Suggest Speed \& Authority (Variation: Unsafe Suggestion)}
    \begin{center}
    \resizebox{\textwidth}{!}{
        \begin{sequencediagram}
            \newthread{ctc}{CTC}
