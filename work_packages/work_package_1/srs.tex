...
\subsection{Functional Requirements}
\begin{enumerate}
	\item The Train Controller shall have an algorithm capable of calculating a minimum safe stopping distance for the train in question.
	\begin{enumerate}
		\item The minimum safe stopping distance shall be a function of the train's current authority.
    ...
    \begin{enumerate}
        ...
        \item The Train Controller shall have the capability to control lights manually if desired.
    ...
    \begin{enumerate}
        \item The upcoming stop and the distance to that stop shall display the stop or station no more than one block before the block that contains the relevant stop or station.
